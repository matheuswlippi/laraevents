                            ...
                            <td class="text-right">
                                <div class="d-flex align-items-center justify-content-end">
                                    @if ($eventStartDateHasPassed)
                                        <form method="POST" action="{{ route('organization.events.presences', ['event' => $event->id, 'user' => $user->id]) }}">
                                            @csrf
                                            <button
                                    ...
                                    @if (!$eventEndDateHasPassed)
                                        <form method="POST"
                                            action="{{ route('organization.events.subscriptions.destroy', ['event' => $event->id, 'user' => $user->id]) }}">
                                            @csrf
                                            @method('DELETE')
